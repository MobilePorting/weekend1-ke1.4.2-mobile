...
class ChartingState extends MusicBeatState
{
	...
	override function create()
	{
		...
		leftIcon = new HealthIcon('pico-playable');
		rightIcon = new HealthIcon('darnell');
	...
	function updateHeads():Void
	{
		...
		{
			leftIcon.animation.play('pico-playable');
			rightIcon.animation.play('darnell');
		}
		else
		{
			leftIcon.animation.play('darnell');
			rightIcon.animation.play('pico-playable');
		}
	}
